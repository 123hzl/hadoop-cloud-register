 ...
 * 获取所有图片接口：https://weibo.com/ajax/profile/getImageWall?uid=5297995474&sinceid=0&has_album=true
...
//	1590681790
	...
	public static List<XlwebImagesVO> getImageInfosAll(String uid){
		Map<String,String> param = new HashMap<>();
		param.put("uid",uid);
		param.put("sinceid","0");
